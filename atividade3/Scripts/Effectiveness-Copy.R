...
for(j in 1:10){
  ...
  path <- paste("/Users/baldoino/Dropbox/Professional/Papers/Ongoing/Developer-sensitive Smells/Dados/CSV_Corrigidos/",colnames(developers)[j],"/",colnames(developers)[j]," - ",sep="")
